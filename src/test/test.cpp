...
void TestCases::testCSVBlanks_Pass(){
    CSVReader reader;
    reader.loadCSV("testBlanks.csv");
    ...
    QVERIFY(numRows*numColumns == count);


}
void TestCases::testCSVBlanks_Fail(){
    ...
    QVERIFY(numRows*numColumns == count+1);
